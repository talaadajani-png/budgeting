            ...
            <div>
              ...
              {accounts.length === 0 ? (
                <div className="bg-[#FBF9F4] rounded-3xl p-6 text-sm text-[#1A1A1A]/50">
                  No accounts linked yet. Click “Link account” to connect a bank
                  via Plaid.
                </div>
              ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-xs text-[#1A1A1A]/50 truncate">
                          {a.plaid_items?.institution_name ?? a.subtype ?? ""}
                        </div>
                        <div className="text-xl font-bold mt-2">
                          <Amount
                            value={a.current_balance ?? 0}
                            currency={a.iso_currency ?? "USD"}
                          />
                        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            backgroundColor: isIncome ? ACCENTS.green : "#EDE7DA",
                          }}
                        >
                          ...
                          >
                            ...
                            <td className="py-3">
                              <span
                                ...
                                style={{
                                  backgroundColor: t.pending ? ACCENTS.yellow : ACCENTS.green,
                                }}
                              >
    ...
    <button
      ...
      className={`rounded-full px-4 py-1.5 text-sm font-medium transition ${
        active
          ...
          : "bg-white/60 text-[#1A1A1A]/70 hover:bg-white"
      }`}
    >
      {label}
    </button>
